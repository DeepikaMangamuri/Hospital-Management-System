...
<body>
    <table class="table table-bordered">
        ...
        <tr bgcolor=red>
            <td>
                <font size=4 color=white>Patient
                    List</font>
            </td>
        </tr>
        <tr>
            <td><a href=padd.php>Add New Record</a></td>
        </tr>
        <tr>
            <td>
                <table width=750 cellspacing=0 cellpadding=5>
                    ...
                    $rs1 = mysqli_query($connection, "SELECT * from patient where pshow='Y' order by
pname;");
                    $sno = 1;
        ...
        <tr>
            <td>
                <table width=750 cellspacing=0 cellpadding=5>
                    ...
                    <?php
                    $rs2 = mysqli_query($connection, "SELECT * from patient where pshow='N' order by
pname;");
                    $sno = 1;
